...
from .segmentation import (cvprsegm, PostProcessSegm,
                           dice_loss, sigmoid_focal_loss)
from .transformer import build_transformer


class cvpr(nn.Module):
    """ This is the cvpr module that performs video object detection """
    def __init__(self, backbone, transformer, num_classes, num_frames, num_queries, aux_loss=False):
        ...
        Parameters:
            ...
            num_queries: number of object queries, ie detection slot. This is the maximal number of objects
                         cvpr can detect in a video. For ytvos, we recommend 10 queries for each frame,
...
class SetCriterion(nn.Module):
    """ This class computes the loss for cvpr.
